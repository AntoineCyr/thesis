...
%constraints -> r1cs (===), (<==) add constraints to the system,
%when compile the circuit genereate r1cs file and witness file
...
%graph of circuits, explain that folded circuits are the same, but inputs and outputs format change
%rework pseudocode of circuits